...
data_zip_race$fluseasCDPH_2_5$all = data_zip_race$fluseasCDPH_2_5$all %>% 
  mutate(race = ifelse((race == "API" | race == "White"), "white_api", race))
data_zip_race$fluseasCDPH_2_5$eld = data_zip_race$fluseasCDPH_2_5$eld %>% 
  mutate(race = ifelse((race == "API" | race == "White"), "white_api", race))
data_zip_race$fluseasCDPH_2_5$nonelem = data_zip_race$fluseasCDPH_2_5$nonelem %>% 
  mutate(race = ifelse((race == "API" | race == "White"), "white_api", race))
